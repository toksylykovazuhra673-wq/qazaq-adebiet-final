...
export default function WriterShortStoriesTab({ writer }: { writer: Writer }) {
  if (!writer.stories || writer.stories.length === 0) {
    return (
      <div className="glass-panel rounded-2xl p-10 text-center">
        <p className="text-white/60 text-lg">Әңгімелер тізімі әзірге бос.</p>
      </div>
    );
  }
